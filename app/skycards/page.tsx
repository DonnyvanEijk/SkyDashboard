...
const SkycardsPage = () => {
  ...
  return (
    <div className="relative">
      <Link href="/">
      <button className="bg-rose-500 text-white p-2 ml-7 mt-7 rounded-md hover:bg-rose-600 transition-all duration-300 w-[10rem]">Go back to home</button>
      </Link>
